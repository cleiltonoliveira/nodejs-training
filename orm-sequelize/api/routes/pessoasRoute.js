...
router.get('/pessoas/matricula/:turmaId/confirmadas', PessoaController.findRegistrationsByClass)
router.get('/pessoas/matricula/lotada', PessoaController.findFulledClasses)
